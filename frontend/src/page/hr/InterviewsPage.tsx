        ...
        <div className="p-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">จัดการตารางนัดหมายสัมภาษณ์</p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-16 flex flex-col items-center justify-center gap-4">
                ...
                <div className="text-center">
                    <p className="text-slate-700 font-bold text-lg">ยังไม่มีนัดหมาย</p>
                    <p className="text-slate-400 text-sm mt-1">กดปุ่ม "นัดหมายใหม่" เพื่อสร้างนัดหมายสัมภาษณ์</p>
                </div>
            </div>
        </div>
    );
